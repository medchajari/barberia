...
btnEliminar.addActionListener(new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (clienteSeleccionado != null) {
            int confirmacion = JOptionPane.showConfirmDialog(null, 
                "¿Estás seguro de que deseas eliminar a " + clienteSeleccionado.getNombre() + clienteSeleccionado.getIdCliente()+ "?", 
                "Confirmar eliminación", JOptionPane.YES_NO_OPTION);

            if (confirmacion == JOptionPane.YES_OPTION) {
                clienteData.eliminarCliente(clienteSeleccionado.getIdCliente());
                JOptionPane.showMessageDialog(null, "Cliente eliminado exitosamente.");
                cbxClientes.removeItem(clienteSeleccionado); // Eliminar del ComboBox
            }
        } else {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 650, 340));

        jLabel2.setText("Nombre y Apellido");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 20, -1, -1));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 70, 190, 10));

        txtNombre.setBorder(null);
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 40, 190, 30));

        btnAgregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/agregar-contacto.png"))); // NOI18N
        ...
        jPanel1.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 230, 190, 40));

        jPanel1.add(cbxClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 330, 190, 40));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 300, -1, -1));

        jLabel3.setText("Dirección");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 90, -1, -1));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 130, 190, 10));

        txtDireccion.setBorder(null);
        jPanel1.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 110, 190, 20));

        txtTelefono.setBorder(null);
        jPanel1.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 170, 190, 30));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 200, 190, 20));

        jLabel4.setText("Telefono");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 150, -1, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 190, 40));
