...
public class Principal extends javax.swing.JFrame {
    ...
    public Principal() {
        ...
        jMenu2.setForeground(new Color(255, 255, 255)); // Texto blanco en el segundo menú
         jMenu3.setForeground(new Color(255, 255, 255)); // Texto blanco en el primer menú
        jMenu4.setForeground(new Color(255, 255, 255)); // Texto blanco en el segundo menú
         jMenu5.setForeground(new Color(255, 255, 255)); // Texto blanco en el primer menú
    ...
    private void initComponents() {
        ...
        mBarbero = new javax.swing.JMenuItem();
        ...
        jMenu7.setPreferredSize(new java.awt.Dimension(60, 28));
        ...
        jMenu3.setForeground(new java.awt.Color(107, 62, 19));
        jMenu3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/espuma-para-el-cabello.png"))); // NOI18N
        jMenu3.setText("Productos");
        jMenu3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jMenu3.setMargin(new java.awt.Insets(3, 20, 3, 6));

        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/espuma-para-el-cabello.png"))); // NOI18N
        jMenuItem3.setText("Agregar Producto");
        jMenuItem3.setPreferredSize(new java.awt.Dimension(146, 38));
        ...
        jMenuItem6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/boton-mas.png"))); // NOI18N
        jMenuItem6.setText("Agregar Stock");
        jMenuItem6.setPreferredSize(new java.awt.Dimension(200, 38));
        ...
        jMenuItem9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/cuchilla-de-afeitar.png"))); // NOI18N
        jMenuItem9.setText("Abastecer Sucursal");
        jMenuItem9.setPreferredSize(new java.awt.Dimension(118, 38));
        ...
        jMenu4.setMaximumSize(new java.awt.Dimension(100, 32767));
        ...
        jMenu6.setMinimumSize(new java.awt.Dimension(100, 28));
        jMenu6.setPreferredSize(new java.awt.Dimension(100, 28));
        ...
        jMenu5.setForeground(new java.awt.Color(107, 62, 19));
        jMenu5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/lista (1).png"))); // NOI18N
        jMenu5.setText("Informes");
        jMenu5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jMenu5.setMargin(new java.awt.Insets(3, 20, 3, 6));
        jMenu5.setMaximumSize(new java.awt.Dimension(105, 32767));
        jMenu5.setMinimumSize(new java.awt.Dimension(105, 28));
        jMenu5.setPreferredSize(new java.awt.Dimension(105, 28));

        jMenuItem12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/sin-contacto.png"))); // NOI18N
        jMenuItem12.setText("Informe de Caja");
        jMenuItem12.setPreferredSize(new java.awt.Dimension(132, 38));
        ...
        jMenuItem14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/espuma-para-el-cabello.png"))); // NOI18N
        jMenuItem14.setText("Informe de Stock");
        jMenuItem14.setPreferredSize(new java.awt.Dimension(138, 38));
        ...
        jMenu2.setForeground(new java.awt.Color(107, 62, 19));
        jMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/edicion.png"))); // NOI18N
        jMenu2.setText("Configuración");
        jMenu2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jMenu2.setMargin(new java.awt.Insets(3, 20, 3, 6));

        mBarbero.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/barbero.png"))); // NOI18N
        mBarbero.setText("Barberos");
        mBarbero.setPreferredSize(new java.awt.Dimension(146, 38));
        mBarbero.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mBarberoActionPerformed(evt);
            }
        });
        jMenu2.add(mBarbero);

        jMenuItem4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/peluqueria (1).png"))); // NOI18N
        jMenuItem4.setText("Sucursal");
        jMenuItem4.setPreferredSize(new java.awt.Dimension(146, 38));
        ...
        jMenuItem5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/caspa.png"))); // NOI18N
        jMenuItem5.setText("Servicios");
        jMenuItem5.setPreferredSize(new java.awt.Dimension(146, 38));
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/lista (1).png"))); // NOI18N
        jMenuItem2.setText("Almacen");
        jMenuItem2.setPreferredSize(new java.awt.Dimension(118, 38));
    ...
    private void mBarberoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mBarberoActionPerformed
        Barberos barb = new Barberos();
        barb.setVisible(true);
    }//GEN-LAST:event_mBarberoActionPerformed
...
cc.setVisible(true);
    ...
    private void jMenuItem12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem12ActionPerformed
      informeCaja ic = new informeCaja();
ic.setVisible(true);
    }//GEN-LAST:event_jMenuItem12ActionPerformed

    private void jMenuItem14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem14ActionPerformed
         informeStock is = new informeStock();
is.setVisible(true);
    ...
    private javax.swing.JMenuItem mBarbero;
