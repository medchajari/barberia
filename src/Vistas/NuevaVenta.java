...
tableBuscar.setModel(modeloBuscar);
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbxTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 240, 210, 30));
        ...
        jPanel1.add(cbxBarbero, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 170, 210, 30));

        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 60, 10, 290));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel1.setText("Seleccione Barbero");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 150, 140, 20));
        ...
        jPanel1.add(cbxClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 310, 210, 30));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel6.setText("Buscar Producto o Servicio");
        ...
        jPanel1.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 290, 40));

        btnBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/22/lupa (1).png"))); // NOI18N
        jPanel1.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 80, 50, 40));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, 140, 20));

        jPanel1.add(cbxLocal, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 100, 210, 30));
    ...
    if (barberoSeleccionado == null || clienteSeleccionado == null || tipoPagoSeleccionado == null || localSeleccionado == null) {
    ...
    for (int i = 0; i < numFilas; i++) {
        ...
        boolean hayStock = stockData.hayStockEnLocal(idProducto, localSeleccionado.getIdLocal(), cantidad);
        ...
        stockData.descontarStockDeLocal(idProducto, localSeleccionado.getIdLocal(), cantidad);
    }
    ...
    int idCajaBarbero = cajaData.obtenerCajaBarberoDelDia(barberoSeleccionado.getIdBarbero());
    if (idCajaBarbero == -1) {
        idCajaBarbero = cajaData.abrirCajaBarbero(barberoSeleccionado.getIdBarbero(), idCajaGeneral); // Si no hay una caja del barbero, abre una nueva
